...
Fully containerized with Docker Compose. Includes Alembic migrations, health checks, Redis Pub/Sub notifications, and a Swagger UI for testing all endpoints.
